...
Once the `conda-forge` channel has been enabled, `banana-hep` can be installed with:

```
conda install banana-hep
```

It is possible to list all of the versions of `banana-hep` available on your platform with:
